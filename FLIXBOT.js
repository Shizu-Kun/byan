...
let audio = {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: 'SALAM',
        sourceUrl: '',
        thumbnail: await (await Fernazerini.getFile('https://telegra.ph/file/efff97e41fb636db8ad43.jpg')).data,
  ...
  let verif = {
            ...
            { remoteJid: "6281351537697-1625305606@g.us" } : {}) 
                       },
            message: {
                conversation: `_YANZOFFC Terverifikasi Oleh WhatsApp_`
            }
        }
...
async function aiBeta(message) {
    return new Promise(async (resolve,reject) => { 
        try {
            const params = {
                message: message,
                apikey: 'btzyanzefriz' //Ganti pake apikeymu
            };
...
"message": {
"groupInviteMessage": {
"groupJid": "6281351537697-1616169743@g.us",
"inviteCode": "m",
    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ video : fs.readFileSync('./asset/image/thum.mp4')}, { upload: Fernazerini.waUploadToServer})), 
                  title: '`OLINE MD BY YANZOFFC`',
                  gifPlayback: false,
                  subtitle: ownername,
          ...
          contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                  newsletterJid: '120363313967186583@newsletter',
...
case 'socialmedia': 
    ...
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'http://t.me/im_Yanz', // Command (URL in this case)
        'cta_url', // Button type
        'http://t.me/im_Yanz' // URL (used in image generation)
    ], 
    [
    ...
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://www.instagram.com/yanzelfriz_', // Command (URL in this case)
        'cta_url', // Button type
        'https://www.instagram.com/yanzelfriz_' // URL (used in image generation)
    ], 
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://Wa.me/6281351537697', // Command (URL in this case)
        'cta_url', // Button type
        'https://Wa.me/6281351537697' // URL (used in image generation)
    ], 
];
...
"showAdAttribution": true,
"renderLargerThumbnail": true,
"title": Styles(`ʏᴀɴᴢᴏꜰꜰᴄ`), 
"containsAutoReply": true,
"mediaType": 1, 
"jpegThumbnail": fs.readFileSync("./Inimedia/image/Fernazerini.jpg"),
"mediaUrl": `https://telegra.ph/file/efff97e41fb636db8ad43.jpg`,
"sourceUrl": `https://instagram.com/yanzelfriz_`
}}}, { quoted: fcall })
}
break
...
anyone like it? please upgrade Premium User to owner`
  Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/efff97e41fb636db8ad43.jpg" }, caption: teks28 }, { quoted: fcall })
}
...
break
case 'sc': case 'script': {
tut = `Kakak Bisa Menghubungi YANZOFFC Untuk Menanyakan nya`
...
Jika Ingin Menyewa OLINE MD Silahkan Ketik .pembayaran 
`)
}
break
case 'delprem': {
...
break
case "bcimg": {
if (!isCreator) return reply(`ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ ᴅᴏᴀɴᴋ ʟᴏʟ`)
...
break
case 'restart':
if (!isCreator) return reply('ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ ᴅᴏᴀɴᴋ')
reply(`ᴍʀᴇsᴛᴀʀᴛ ʏᴀɴᴢᴏꜰꜰᴄ....`)
await sleep(3000)
process.exit()
break
case 'runtime': {
...
break
case 'delcase': {
if (!isCreator) return reply(`ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ ᴀᴊ ʟᴏʟ`)
...
break
case "listgc":{
if (!isCreator) return (`ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ ᴀᴋ ʟᴏʟ ᴡᴋᴡᴋ`)
let getGroups = await Fernazerini.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let hituet = 0
...
break
case 'antilink': {
if (!isCreator) return reply('*khusus ʏᴀɴᴢᴏꜰꜰᴄ*')
...
reply('OLINE MD SUKSES MODE PUBLIC')
}
break
case 'self': {
if (!isCreator) return mess.owner
Fernazerini.public = false
reply('OLINE MD SUCCES MODE SELF')
}
break
//================ D O W N L O A D ==================//
...
if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
if (!text) return reply(`ʟɪɴᴋ ɴʏ ᴍɴ ʙɪᴀʀ ʏᴀɴᴢᴏꜰꜰᴄ ᴘʀᴏsᴇs`)
let old = new Date()
...
{
"externalAdReply": {
"title": 'sᴘᴏᴛɪғʏ ʙʏ ʏᴀɴᴢᴏꜰꜰᴄ',
"body": `ʏᴀɴᴢᴏꜰꜰᴄ`,
"showAdAttribution": true,
"mediaType": 1,
"sourceUrl": '',
"thumbnailUrl": 'https://telegra.ph/file/efff97e41fb636db8ad43.jpg',
"renderLargerThumbnail": true
}
}}, {quoted: fcall})
...
let teks = m.quoted ? quoted.text : text
 try {
   try {
                    ...
                    pic = 'https://telegra.ph/file/efff97e41fb636db8ad43.jpg'
                }
         const obj = {
            "type": "quote",
            "format": "png",
...
if (!isBotAdmins) return reply(mess.badm)
await loading()
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281351537697`)
...
Done Bwang Kuhhh Kamu Sekarang Sudah Bisa Mengakses OLINE MD Abangkuhh Btw Limit Gada Reset Reset an Jika Limit Habis Silahkan Buy Limit Di YANZOFFC`
veri = m?.sender
if (!m.isGroup) {
...
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = true
reply('SUCCES PUBLIC KAK ʏᴀɴᴢᴏꜰꜰᴄ')
}
break
case 'self': {
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = false
reply('SUCCES SELF KAK ʏᴀɴᴢᴏꜰꜰᴄ')
}
break
...
break
      ...
      case "listsw": {
        ...
        break;
case 'emojimix': { 
if (isBan) return m.reply('ʟᴜ ᴅɪ ʙᴀɴ ᴏʟᴇʜ ʏᴀɴᴢᴏꜰꜰᴄ')
await loading()
...
break 
        case 'group': {   
if (!isCreator) return m.reply('ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ')
if (!m.isGroup) return m.reply('ᴋʜᴜsᴜs ɢʀᴏᴜᴘ')
...
Fernazerini.sendMessage(m.chat, { image: ppnyauser, caption: `ᴄᴏɴᴛᴏʜ ; .ʏᴀɴᴢᴏꜰꜰᴄ ᴛᴜᴛᴜᴘ ɢʀᴏᴜᴘ
ᴄᴏɴᴛᴏʜ : .ʏᴀɴᴢᴏꜰꜰᴄ ʙᴜᴋᴀ ɢʀᴏᴜᴘ`}, {quoted:m}) 
 }
}
break
case "antitoxic":
...
case '1gb': {
        if (!isPrem) return reply(`ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ`)
...
akunlo = "https://telegra.ph/file/efff97e41fb636db8ad43.jpg" 
if (!u) return
...
break
case "2gb": {
    if (!isPrem) return reply(`Anda Belum Menjadi Reseler Beli Reseler Skrng Di Yanzoffc agar Bisa Mengakses Fitur Cpanel`)
...
GROUP OFICIAL
• https://chat.whatsapp.com/L3f8QjuVJ9s5Tfp6jk9q0E
...
break
case "8gb": {
if (!isPrem) return reply(`ʙᴜʏ ᴘʀᴇᴍ ᴅʟᴜ ᴅɪ ʏᴀɴᴢᴏꜰꜰᴄ`)
let t = text.split(',');
if (t.length < 2) return reply(`*Format salah!*
Penggunaan:
${prefix + command} user,nomer`)
...
NOTES!! *JIKA MEMBUAT WAJIB DI GUNAKAN AGAR PANEL TIDAK DELAY*`
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 forwardedNewsletterMessageInfo: {
 newsletterJid: '120363313967186583@newsletter',
 newsletterName: 'Powered By ʏᴀɴᴢᴏꜰꜰᴄ', 
 serverMessageId: -1
},
 ...
 title: `ʙᴜʏ ᴘᴀɴᴇʟ ʀᴇᴋ`,
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/efff97e41fb636db8ad43.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
 buttons: [ 
 {
...
break
case "detusr": {
if (!isCreator) return reply(`*Anda Belum Menjadi Reseler Beli Reseler Skrng Di Yanzoffc agar Bisa Mengakses Fitur Cpanel!*`)
let usr = args[0]
...
break
case "listsrv": {
  if (!isCreator) return reply(`ᴋʜᴜsᴜs ʏᴀɴᴢᴏꜰꜰᴄ.`);
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 header: proto.Message.InteractiveMessage.Header.create({
 title: Styles(`ʙᴜʏ ᴘᴀɴᴇʟ ᴅ ʏᴀɴᴢᴏꜰꜰᴄ ʏᴏᴋ`),
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/efff97e41fb636db8ad43.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
...
case 'tutorial': {
await loading()
tut = `ᴛᴜᴛᴏʀ ʀᴜɴ ᴘᴀɴᴇʟ ʙʏ ʏᴀɴᴢᴏꜰꜰᴄ
https://youtube.com/`
await Fernazerini.relayMessage(m.chat,  {
requestPaymentMessage: {
currencyCodeIso4217: 'IDR',
     ...
     await reply("ᴡᴀɪᴛ ʙᴀᴄᴋᴜᴘ sᴄ Ganyu ᴠ4.5");
          ...
          await Fernazerini.sendMessage(
            m.chat,
            {
              ...
              fileName: "ʏᴀɴᴢᴏꜰꜰᴄ.zip",
            },
            { quoted: fcall }
          );
          await execSync("rm -rf ʏᴀɴᴢᴏꜰꜰᴄ.zip");
        }
        break
//=================================================//
case 'buatgc': 
...
RAM UNLI = 10K
▬▭▬▭▬▭▬▭▬▭▬▭▬▭
*OPEN PT PANEL 20.000*
*OPEN ADMIN PANEL 10.000*
*OPEN RESELLER PANEL 5.000*
...
case "sisalinode": {
  ...
  async function sisalinodeHandler() {
    try {
      if (!isCreator) {
        return reply('Lu Siapanya Gua bang');
      }
...
case "rebuildlinode": {
  if (!isCreator) return reply(`Lu Siapanya Gua bang Gausah Nyuruh Nyuruh Gua bisa kan`);
...
case "linode8gb": {
  if (!isCreator) return reply(`Khusus ʏᴀɴᴢᴏꜰꜰᴄ Saja Suki`);
  try {
    let linodeData = {
      label: `${args[0]}`,
...
break;
 ...
 case "offlinode": {
  if (!isCreator) return reply(`Sok Asik Bang`);
...
// DO
case "sisadroplet":{
if (!isCreator) return reply(`Ngapain Bang? Lu siapa?`)
...
case "rebuild": {
  if (!isCreator) return reply(`Lu Siapanya Gua Bang Gausah Nyuruh Nyuruh Gua Yatim`);
...
case 'svps': case 'sendvps': {
		 if (!isCreator) return (`Ngapain Sih`)
...
𝗧𝗲𝗿𝗶𝗺𝗮𝗸𝗮𝘀𝗶𝗵 𝗧𝗲𝗹𝗮𝗵 𝗢𝗿𝗱𝗲𝗿 𝗗𝗶 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾
...
Itulah Rules OLINE MD Kak Jangan Langgar Ya Kak`)
             await Fernazerini.sendMessage(m.chat, {audio: fs.readFileSync('./Vn/rulesy.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:m})}
             break
             case 'formatneed': {
             reply(`*FORMAT NEED AKUN BY 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾*
_NOTE!!! : INI BUKAN 100% AKUN MILIK ADMIN ATAU 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾 TETAPI AKUN MILIK SELER!!!_
...
_JANGAN LUPA SLALU MENGGUNAKAN JASA ADMIN 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾 AGAR TERHINDAR DARI PENIPUAN ATAU MODUS LAINNY_`)
}
break
case 'formatjp': {
reply(`*FORMAT JASA PSOT AKUN BY 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾*
...
break
case 'feerekber': {
reply(`ALL FEE REKBER DI 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾 HANYA 5K`)
}
break
case 'feegc': {
reply(`langsung culik 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾`)
}
break
case 'donasi': {
teks28 = `*『 DONASI 』*
Terimakasih Telah Berdonasi Kak 𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾 akan Terus Mengembangkan Bot ini Insyaallah

Dana: 081351537697
Qris : https://telegra.ph/file/74d65fddc07f7a173b1ba.jpg

Jangan Lupa Send Bukti TF `
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/74d65fddc07f7a173b1ba.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
case "gempa": {
...
if (!isCreator) return (`Khusus ʏᴀɴᴢᴏꜰꜰᴄ`)
if (args[0] == 'on'){
...
break
case 'paptt1': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di ʏᴀɴᴢᴏꜰꜰᴄ Wkwk`)
...
Fernazerini.sendMessage(m.sender, { image: { url: yeha }, caption : '© OLINE MD 2023 - 2024'}, { quoted: m })
}
break
case 'tiktokgirl':
await loading()
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281351537697',
title: `𝙔𝘼𝙉𝙕𝙊𝙁𝙁𝘾`,
sourceUrl: `https://wa.me/+6281351537697`, 
thumbnail: thumb
}
}})
break
...
break   
case 'dana': {
reply(`Dana 082252626610 : Bukti? ketik .bukti dana 1000`)
}
break
case 'saldo':{
...
Fernazerini.sendMessage('6281351537697@s.whatsapp.net', { text: `*ADA YANG DEPOSIT NIH*\n\n*@${sender.split('@')[0]}`, mentions: [sender]}, { quoted: m })
        }
        break
        case 'dana': {
        reply(`Dana :082252626610 Ss Bukti Dengan Cara .bukti Dana 1000`)
        }
        break
        case 'qris': {
await loading()
...
*ɴᴏᴛᴇ* : _ᴊɪᴋᴀ ꜱᴜᴅᴀʜ ᴛʀᴀɴꜱꜰᴇʀ ꜱɪʟᴀʜᴋᴀɴ ᴋᴇᴛɪᴋ ᴄᴏɴᴛᴏʜ : .ʙᴜᴋᴛɪ Qʀɪꜱ5ᴋ ,, ᴅᴀɴ ꜱᴇʀᴛᴀᴋᴀɴ ɴᴀᴍᴀ ᴘᴇɴɢɪʀɪᴍ ᴇ-ᴡᴀʟᴇᴛ ᴄᴏɴᴛᴏʜ : ᴀᴛᴀꜱ ɴᴀᴍᴀ ᴅᴀɴᴀ : ʏᴀɴᴢᴏꜰꜰᴄ ʜᴀɴʏᴀ ᴄᴏɴᴛᴏʜ ,, ᴊɪᴋᴀ ᴛɪᴅᴀᴋ ᴍᴇɴɢɪᴋᴜᴛɪ ᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪ ᴘʀᴏꜱᴇꜱ_
...
break
       case 'nowa': {
if (!isCreator) return reply(`Khusus ʏᴀɴᴢᴏꜰꜰᴄ Aja`)
...
break
 ...
 if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
if (!text) return m.reply("ketik nama lu Bang")
...
break
 ...
 if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
if (!text) return reply('Ketik Namanya Bang!')
reply(`
╭━━━━°「 *Memek ${text}* 」°
┃
┊• Nama : ${text}
...
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./Inimedia/image/Fernazerini.jpg`),
"sourceUrl": `http://wa.me/+6281351537697`}}},
{ quoted: m})
}
break
        case "sad1":
...
if (!isPrem) return reply('Khusud Prem Yang Mau Buy Prem Ke Owner')
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          ...
          babuk.forwardedNewsletterMessageInfo.newsletterJid = "120363313967186583@newsletter";
...
"message": "",
"orderTitle": "ALBYS",
"sellerJid": "6281351537697@s.whatsapp.net",
...
"groupInviteMessage": {
"groupJid": "120363256275075842@g.us",
"inviteCode": "/L3f8QjuVJ9s5Tfp6jk9q0E",
...
if (!isPrem) return reply('Khusud Prem Yang Mau Buy Prem Ke Owner')
        for (i = 0; i < 10; i++) {
          ...
          Fernazerini.sendMessage(m.chat, {
            ...
            'contextInfo': {
              'externalAdReply': {
                'title': "YAHAA LAG KASIAN " + ('' + "🪓.78/24.```🧙```.*~999999~*.🪄._66/77_._🧚‍♀️_.~_24.*23*/24_~.⛽._18/05_.98-23.~🦧~.~¿~*77/90*.*🐒*.~2/63.~🌗.~*22*-00~.".reSiht(255)),
                'body': "BY ALBYS" + ('' + "🪓.78/24.```🧙```.*~999999~*.🪄._66/77_._🧚‍♀️_.~_24.*23*/24_~.⛽._18/05_.98-23.~🦧~.~¿~*77/90*.*🐒*.~2/63.~🌗.~*22*-00~.".reSiht(255)),
                'reviewType': "PHOTO",
...
case 'santetgctroli': {
if (!isPrem) return reply('Khusud Prem Yang Mau Buy Prem Ke Owner')
let result = args[0].split('https://chat.whatsapp.com/GXHDKRNXA0a73MXS3kP951/')[1]
...
buttons: [{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"No\",\"url\":\"https://wa.me/6281351537697\",\"merchant_url\":\"https://wa.me/\"}`
}, {
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Channel \",\"url\":\"https://whatsapp.com/channel/0029VajkWCHA2pL8HbI48k1g\",\"merchant_url\":\"https://whatsapp.com/channel/0029VajkWCHA2pL8HbI48k1gchannel/0029VajkWCHA2pL8HbI48k1g\"}`
}, {
"name": "cta_url",
