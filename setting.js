...
global.ownername = 'ʏᴀɴᴢᴏꜰꜰᴄ' // Owner Name
global.owner = ['6281351537697'] // Nomor Owner
global.botname = 'ᴏʟɪɴᴇ ᴍᴅ' // Nama Bot
// ====================== \\

// SETTING IN WM \\
global.packname = 'ʏᴀɴᴢᴏꜰꜰᴄ' // Name Sticker
global.author = `ᴏʟɪɴᴇ ᴍᴅ` // Name Sticker 
...
global.versi = '5.0.0'
global.gris = '`'
global.wm = `ᴏʟɪɴᴇ ᴍᴅ` // Ubah Ae
global.namaStore = 'ʏᴀɴᴢᴏꜰꜰᴄ' // Ubah Ae
global.ownerStore = 'ʏᴀɴᴢᴏꜰꜰᴄ' // Ubah Ae
global.autobio = false // True Jika Langsung On False Jika Off
global.autoread = false // True Jika Langsung On False Jika On
global.thumbnail = 'https://telegra.ph/file/efff97e41fb636db8ad43.jpg'
// ====================== \\

// SETTING IN APIKEY CPANEL \\
global.footer2 = Styles('CREATED FERNAZER')
global.domain = 'https://alfaxyanz.windastore.live' // Isi Domain Lu
global.apikey2 = 'ptla_y2W7n9vGQQIqDSMBj7WHJxJLeR9wOmkHXmGWfz7WnSQ' // Isi Apikey Plta Lu
global.capikey2 = 'ptlc_lAl50eDeauBkzQqcFcTeWrmtkMDhIE3yooRh3DdiTUX' // Isi Apikey Pltc Lu
